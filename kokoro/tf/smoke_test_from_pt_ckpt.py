"""Smoke-test utility: run TF generator initialized from PyTorch checkpoint.

This module is a minimal end-to-end sanity check for checkpoint conversion:
- Load a PyTorch generator checkpoint.
- Build the equivalent TensorFlow model.
- Map weights into TensorFlow.
- Run one paired vocoder feature input and write a WAV output.

It is intended for quick correctness checks before longer training/export runs.
"""
